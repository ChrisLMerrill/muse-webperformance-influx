...
@MuseSubsourceDescriptors(
	...
	MuseSubsourceDescriptor(displayName = "Port", description = "Port on Influx server (defaults to 8086)", type = SubsourceDescriptor.Type.Named, name = MeasurementsToInfluxConfiguration.PORT_PARAM, optional = true, defaultValue = MeasurementsToInfluxConfiguration.PORT_PARAM_DEFAULT),
	MuseSubsourceDescriptor(displayName = "Database", description = "Name of Influx database to send measurements to", type = SubsourceDescriptor.Type.Named, name = MeasurementsToInfluxConfiguration.DATABASE_PARAM, optional = true, defaultValue = "telegraf"),
...
class MeasurementsToInfluxConfiguration : GenericResourceConfiguration(), PluginConfiguration
{
	...
	{
		var port = PORT_PARAM_DEFAULT.toInt()
	...
	companion object
	{
		...
		const val PORT_PARAM_DEFAULT = "8086"
	}
}